    ...
    if (data.type === 'show_question') {
        ...
        if (questionUrl) {
            fetch(questionUrl)
                ...
                .then(html => {
                    // Using querySelectorAll to select all elements in the body and hide them
        ...
        // We hide all the elements in the body and append the resultsContainer to the body
