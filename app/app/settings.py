...
SECRET_KEY = 'django-insecure-r!^1wcctwao8=jfio!*fg-8q4*8!*i$xf*954)@irn+!n9+e1m'
...
# The STATIC_ROOT setting is the absolute path to the directory where Django will collect static files for deployment.
